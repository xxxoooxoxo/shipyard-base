...
/**
 * Base UI compat: the old base-nova kit exported `NavigationMenuPositioner`.
 * Radix has no Positioner concept — its closest equivalent is the Viewport —
 * so the old name is kept as an alias to preserve import parity.
 */
